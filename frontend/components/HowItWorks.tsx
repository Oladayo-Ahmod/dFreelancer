            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="main-title text-center">
                        <h2>How It Works</h2>
                        <p className="text">Highly popular and best-selling services of all time.</p>
                    </div>
                </div>
            </div>
            <div className="row">
                <div className="col-sm-6 col-lg-3">
                    <div className="iconbox-style1 border-less p-0">
                        ...
                        <div className="details">
                            ...
                            <p className="text">Posting a job is simple and free. Just enter <br className="d-none d-xxl-block" /> a title and description.</p>
                        </div>
                    </div>
                </div>
                <div className="col-sm-6 col-lg-3">
